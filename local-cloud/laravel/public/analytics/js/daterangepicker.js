...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '<input class="input-small" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
            '</div>' +
            '<div class="daterangepicker_end_input">' +
            '<label for="daterangepicker_end"></label>' +
            '<input class="input-small" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
            '</div>' +
            '<button class="applyBtn" disabled="disabled" style="display:inline-block;"></button>&nbsp;' +
            '</div>' +
            '</div>' +
            '</div>';
...
//        this.showCalendars();
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.buttonClasses = ['btn', 'btn-small', 'btn-block'];
            ...
            this.locale = {
                ...
                toLabel: 'To',
                weekLabel: 'W',
                customRangeLabel: 'Custom Range <i class="icon-calendar-2"></i>',
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                $('#reportrange span.start-date').html(dates[0].format("MMM D, YYYY"));
                $('#reportrange span.end-date').html(dates[1].format("MMM D, YYYY"));
            }
        },
        ...
        enterDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                $('#reportrange span.start-date').html(this.leftCalendar.calendar[row][col].format("MMM D, YYYY"));
            } else {
                this.container.find('input[name=daterangepicker_end]').val(this.rightCalendar.calendar[row][col].format(this.format));
                $('#reportrange span.end-date').html(this.rightCalendar.calendar[row][col].format("MMM D, YYYY"));
            }
        ...
        updateCalendars: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    if (this.dateLimit.days < this.ranges[range][3].diff(this.ranges[range][2], 'days')) {
                        this.container.find('.ranges li:eq(' + i + ')').addClass('disabled').append("<i class='icon-lock'></i>");
                    } else if (this.startDate.isSame(this.ranges[range][3]) && this.endDate.isSame(this.ranges[range][2])) {
                        customRange = false;
                        this.container.find('.ranges li:eq(' + i + ')').addClass('active').append("<i class='icon-check'></i>");
                    }
                } else {
                    ...
                    if (this.dateLimit.days < this.ranges[range][3].diff(this.ranges[range][2], 'days')) {
                        ...
                        customRange = false;
                        this.container.find('.ranges li:eq(' + i + ')').addClass('active').append("<i class='icon-check-alt'></i>");
                    }
                }
                i++;
            }
