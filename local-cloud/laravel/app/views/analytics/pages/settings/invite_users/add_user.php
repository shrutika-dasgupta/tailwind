...
<div class="row-fluid <?=$user_row_enabled;?>">
    <div class='span12'>
        ...
        <div class="hidden user-row add-user-form">
            ...
            <form method="POST" action="/settings/collaborators/invite">
                ...
                <span class="span5">
                    <span class="btn-group" data-toggle="buttons-radio">
                        <button id="admin-button<?=$user_counter;?>" type="button" class="btn" type="radio" name="is_admin" value="A"
                                ...
                                dashboard."
                                onclick="$('#viewer-button<?=$user_counter;?>').attr('selected','selected').removeClass('active'); confirm('Are you sure you want to add an Admin Collaborator?  ' +
                                 ...
                                 $('#admin-button<?=$user_counter;?>').attr('selected','selected').addClass('active');">
                                Admin
                        </button>
                        <button id="viewer-button<?=$user_counter;?>" type="button" class="btn active" type="radio" name="is_admin" value="V"
                                onclick="$('#admin-button<?=$user_counter;?>').removeClass('active');
                                    $('#viewer-button<?=$user_counter;?>').attr('selected','selected').addClass('active');">Viewer</button>
                    </span>
