...
(function ($) {
    ...
    function fnCreateRangeInput() {
        ...
        var from = $('<input type="text" id="amount" style="border: 0; color: #f6931f; font-weight: bold;" />');
        th.append(from);
        ...
        th.wrapInner('<span class="filterColumn filter_number_range" id="slider-range"/>');
        var index = i;
        ...
        */
        $.fn.dataTableExt.afnFiltering.push(
	        function (oSettings, aData, iDataIndex) {
	            var iMin = document.getElementById(slider-range).slider("values",0) * 1;
	            var iMax = document.getElementById(slider-range).slider("values",1) * 1;
        ...
        $('#slider-range.slider("values", 0)','#slider-range.slider("values", 1 )', th).keyup(function () {
