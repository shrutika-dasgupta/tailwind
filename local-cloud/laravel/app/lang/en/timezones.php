...
return array(
    ...
    |--------------------------------------------------------------------------
    |
    | The following lines are friendlier display names for PHP timezones.
    | They are ordered by timezone offset, location name.
    |
    */
    ...
    'display_names' => array(
        ...
        'Mountain Time (US & Canada)'  => 'America/Denver',                 // (UTC-07:00)
        'Central America'              => 'America/Managua',                // (UTC-06:00)
        'Central Time (US & Canada)'   => 'America/Chicago',                // (UTC-06:00)
        ...
        'Eastern Time (US & Canada)'   => 'America/New_York',               // (UTC-05:00)
        ...
        'Georgetown'                   => 'America/Argentina/Buenos_Aires', // (UTC-03:00)
