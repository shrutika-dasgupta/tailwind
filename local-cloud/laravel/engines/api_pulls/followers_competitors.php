...
/**
 * User Followers for competitor track_type
 *
 * @author Yesh
 *         Alex
 */
...
try {
    ...
    {
        Log::notice('No more users to grab off the queue.  Going idle and sleeping.');
        CLI::sleep(60);
        $engine->idle();
        exit;
    }
...
catch (Pinterest\PinterestException $e) {
