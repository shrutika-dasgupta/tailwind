...
<div class="pinner-profile">
    <a href="http://pinterest.com/<?= $pinterest_username ?>" target="_blank" class="pull-left pinner-profile-<?= $type ?>">
        <img class="pinner-photo" src="<?= $profile->image ?>" />
    </a>

    <div class="pull-left pinner-info">
        <a href="http://pinterest.com/<?= $pinterest_username ?>" target="_blank" class="pinner-name pinner-profile-<?= $type ?>">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                <li>
                    <div class="pinner-social">
                        <a href="http://www.pinterest.com/<?= $pinterest_username ?>" target="_blank" data-pin-do="buttonFollow" class="pinner-pn-<?= $type ?>">
                            Follow
                        </a>
                ...
                <?php if (!empty($twitter_username)): ?>
                    <li>
                        <div class="pinner-social" style="margin-top:8px;">
                            <a href="https://twitter.com/<?= $twitter_username ?>" class="twitter-follow-button pinner-tw-<?= $type ?>" data-show-count="true" data-align="bottom" data-show-screen-name="false">
                                Follow
                            </a>
                        </div>
                    </li>
